...
extern const display_glyph_font_t font_kn;
extern const display_glyph_font_t font_ml;
extern const display_glyph_font_t font_ne;
extern const display_glyph_font_t font_si;
extern const display_glyph_font_t font_km;
...
extern const display_glyph_font_t font_or;
extern const display_glyph_font_t font_sd;
extern const display_glyph_font_t font_mai;
...
extern const char *const lang_kn_shaped[];
extern const char *const weekdays_kn_shaped[7];
extern const char *const months_kn_shaped[12];
extern const char lang_name_kn_shaped[];
extern const char *const lang_ml_shaped[];
extern const char *const weekdays_ml_shaped[7];
extern const char *const months_ml_shaped[12];
extern const char lang_name_ml_shaped[];
extern const char *const lang_ne_shaped[];
extern const char *const weekdays_ne_shaped[7];
extern const char *const months_ne_shaped[12];
extern const char lang_name_ne_shaped[];
extern const char *const lang_si_shaped[];
extern const char *const weekdays_si_shaped[7];
extern const char *const months_si_shaped[12];
extern const char lang_name_si_shaped[];
extern const char *const lang_km_shaped[];
extern const char *const weekdays_km_shaped[7];
extern const char *const months_km_shaped[12];
extern const char lang_name_km_shaped[];
extern const char *const lang_lo_shaped[];
extern const char *const weekdays_lo_shaped[7];
extern const char *const months_lo_shaped[12];
extern const char lang_name_lo_shaped[];
extern const char *const lang_my_shaped[];
extern const char *const weekdays_my_shaped[7];
extern const char *const months_my_shaped[12];
extern const char lang_name_my_shaped[];
extern const char *const lang_am_shaped[];
...
extern const char *const lang_or_shaped[];
extern const char *const weekdays_or_shaped[7];
extern const char *const months_or_shaped[12];
extern const char lang_name_or_shaped[];
extern const char *const lang_sd_shaped[];
extern const char *const weekdays_sd_shaped[7];
extern const char *const months_sd_shaped[12];
extern const char lang_name_sd_shaped[];
extern const char *const lang_mai_shaped[];
extern const char *const weekdays_mai_shaped[7];
extern const char *const months_mai_shaped[12];
extern const char lang_name_mai_shaped[];
