...
static const uint8_t font_high[128][FONT_CHAR_HEIGHT] = {
    ...
    // --- Croatian / Hungarian / Romanian extended Latin (0xC0-0xC9) ---
    // A-acute uppercase (0xC0) - Hungarian
    [0xC0 - 0x80] = {0x0C,0x18,0x10,0x38,0x6C,0xC6,0xC6,0xFE,0xC6,0xC6,0xC6,0xC6,0x00,0x00,0x00,0x00},
    ...
    // --- Uppercase accents and remaining extras (0xD0-0xD4, 0xDA) ---
    // R-caron uppercase (0xD0) - Czech
    [0xD0 - 0x80] = {0x6C,0x38,0xFC,0x66,0x66,0x66,0x7C,0x6C,0x66,0x66,0x66,0xE6,0x00,0x00,0x00,0x00},
    // S-acute uppercase (0xD1) - Polish
    [0xD1 - 0x80] = {0x0C,0x18,0x7C,0xC6,0xC6,0x60,0x38,0x0C,0x06,0xC6,0xC6,0x7C,0x00,0x00,0x00,0x00},
    // z-acute (0xD2) - Polish
    [0xD2 - 0x80] = {0x00,0x00,0x0C,0x18,0x00,0xFE,0xCC,0x18,0x30,0x60,0xC6,0xFE,0x00,0x00,0x00,0x00},
    // I-dot uppercase (0xD3) - Turkish
    ...
    // u-acute (0xFA) - Hungarian
    [0xFA - 0x80] = {0x00,0x00,0x0C,0x18,0x00,0xCC,0xCC,0xCC,0xCC,0xCC,0xCC,0x76,0x00,0x00,0x00,0x00},
    // u-circumflex (0xFB)
