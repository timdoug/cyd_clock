...
// Language identity lives in main/i18n/lang_list.inc: one line per
// language, in NVS-stable order. It expands here into lang_t and in
// i18n_data.inc into the registration tables.
typedef enum {
#define I18N_PLAIN(id, up)  LANG_##up,
#define I18N_SHAPED(id, up) LANG_##up,
